...
#     def on_update(self):
#         """Update the maintenance flag in Hotel Room whenever approval changes"""
...
#         # Determine what the flag should be
#         new_flag = 1 if self.approved else 0

#         frappe.db.set_value("Hotel Room", self.room, "maintenance_flag", new_flag)

#         # Optional: commit immediately to ensure real-time dashboard updates
#         frappe.db.commit()
...
#         # Only create Asset Repair when it becomes approved
...
#     def update_room_maintenance_flag(self):
#         """Toggle Hotel Room maintenance flag based on approval"""
#         if not self.room:
#             return
#         frappe.db.set_value("Hotel Room", self.room, "maintenance_flag", 1 if self.approved else 0)
#         frappe.db.commit()
...
#         # Only allow users with the approval role
...
#         if self.room:
#             frappe.db.set_value("Hotel Room", self.room, "maintenance_flag", 1)
