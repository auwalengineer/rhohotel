...
// // ✅ FIXED: Room dropdown now properly filters booked rooms
// // ✅ Key fix: Added filters: {} to set_query for custom query method
...
//         // ✅ CRITICAL FIX: Filter room_number dropdown by available rooms based on dates
//         // The key is adding 'filters: {}' to tell Frappe to use the custom query method
//         // frm.set_query('room_number', 'rooms', function(doc, cdt, cdn) {
//         //     if (!doc.from_date || !doc.to_date) {
//         //         return { filters: { name: "__none__" } };
//         //     }
...
//         //     return {
//         //         query: 'rhohotel.rhocom_hotel.doctype.hotel_front_desk_reservation.hotel_front_desk_reservation.get_available_rooms_for_dropdown',
//         //         filters: {},  // ✅ IMPORTANT: This empty object tells Frappe to use the custom query
//         //         args: {
//         //             from_date: doc.from_date,
//         //             to_date: doc.to_date,
//         //             room_type: doc.filter_by_room_type || null
...
//             // // ✅ Method 1a: Simple console.log
//             // console.log('set_query called with:', query_result);
            
//             // // ✅ Method 1b: Print each part separately
//             // console.log('From Date:', doc.from_date);
//             // console.log('To Date:', doc.to_date);
//             // console.log('Room Type:', doc.filter_by_room_type);
//             // console.log('Full Query Object:', query_result);
            
//             // // ✅ Method 1c: Pretty print (best for objects)
//             // console.table({
//             //     'from_date': doc.from_date,
//             //     'to_date': doc.to_date,
//             //     'room_type': doc.filter_by_room_type,
//             //     'query_method': query_result.query
//             // });
